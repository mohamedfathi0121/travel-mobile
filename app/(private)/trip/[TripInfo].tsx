...
export default function TripInfo() {
  ...
  const { TripInfo: tripScheduleId } = useLocalSearchParams<{
    TripInfo: string;
  }>();
  ...
  return (
    <SafeAreaView style={{ flex: 1 ,backgroundColor:background}}>
      ...
      >
        ...
        >
          <Pressable
            style={[styles.backBtn , { backgroundColor: buttonPrimary }]}
          ...
          {/* التقييم العام */}
          <View style={[styles.ratingSummary, { borderColor: theme.icon }]}>
            ...
            <View style={styles.ratingOverall}>
              <View style={[{ alignItems: "center" }]}>
                ...
                <ThemedText>{reviews.length} reviews</ThemedText>
              </View>
              <View style={{ flex: 1, marginLeft: 12 }}>
                {[5, 4, 3, 2, 1].map(star => {
                  ...
                  const percent = reviews.length
                    ...
                    : 0;
                  return (
                    <View key={star} style={styles.ratingRowBar}>
                      <ThemedText style={{ width: 20 }}>{star}</ThemedText>
                      <View
                        style={[
          ...
          {!userReview && (
            <>
              ...
              />
              <Pressable style={[styles.submitBtn , { backgroundColor: buttonPrimary }]} onPress={handleSubmit}>
                <ThemedText style={[styles.submitText , { color: buttonText } ]}>Submit</ThemedText>
              </Pressable>
            </>
          )}
        </ScrollView>
